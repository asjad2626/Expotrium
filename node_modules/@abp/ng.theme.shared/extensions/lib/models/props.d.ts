...
export declare abstract class Prop<R = any> {
    ...
    constructor(type: ePropType, name: string, displayName: string, permission: string, visible?: PropPredicate<R>, isExtra?: boolean, template?: Type<any>, className?: string, displayTextResolver?: PropDisplayTextResolver<R>);
}
...
export declare type PropDisplayTextResolver<T> = (data?: Omit<PropData<T>, 'data'>) => string;
