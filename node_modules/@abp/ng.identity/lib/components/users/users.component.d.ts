...
export declare class UsersComponent implements OnInit {
    ...
    constructor(list: ListService<GetIdentityUsersInput>, confirmationService: ConfirmationService, service: IdentityUserService, toasterService: ToasterService, fb: UntypedFormBuilder, injector: Injector);
    ngOnInit(): void;
    buildForm(): void;
    openModal(): void;
    add(): void;
