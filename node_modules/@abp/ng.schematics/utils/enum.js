...
function createImportRefToEnumMapper({ solution, types }) {
    return (ref) => {
        ...
        if (!enumNames || !enumValues)
            throw new schematics_1.SchematicsException((0, common_1.interpolate)("[Type Definition Not Found] There is no type definition for \"{0}\"." /* Exception.NoTypeDefinition */, ref));
