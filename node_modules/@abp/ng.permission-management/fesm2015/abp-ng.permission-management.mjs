    ...
    setDisabled(grantedProviders) {
        if (grantedProviders.length) {
            grantedProviders.forEach(permission => {
                var _a;
                this.disableSelectAllTab = (_a = permission.grantedProviders) === null || _a === void 0 ? void 0 : _a.some(p => p.providerName !== this.providerName);
            });
        }
        else {
            this.disableSelectAllTab = false;
...
PermissionManagementModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.0.3", ngImport: i0, type: PermissionManagementModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
PermissionManagementModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "15.0.3", ngImport: i0, type: PermissionManagementModule, declarations: [PermissionManagementComponent], imports: [CoreModule, ThemeSharedModule], exports: [PermissionManagementComponent] });
PermissionManagementModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "15.0.3", ngImport: i0, type: PermissionManagementModule, imports: [CoreModule, ThemeSharedModule] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.0.3", ngImport: i0, type: PermissionManagementModule, decorators: [{
            type: NgModule,
            args: [{
