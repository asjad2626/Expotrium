...
export declare class PermissionManagementComponent implements PermissionManagement.PermissionManagementComponentInputs, PermissionManagement.PermissionManagementComponentOutputs {
    ...
    setDisabled(grantedProviders: any): void;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PermissionManagementComponent, "abp-permission-management", ["abpPermissionManagement"], { "providerName": "providerName"; "providerKey": "providerKey"; "hideBadges": "hideBadges"; "entityDisplayName": "entityDisplayName"; "visible": "visible"; }, { "visibleChange": "visibleChange"; }, never, never, false, never>;
}
export {};
