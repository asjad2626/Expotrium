...
class ValidationErrorComponent extends ValidationErrorComponent$1 {
    get abpErrors() {
        ...
        return this.errors.map((error) => {
            if (!error.message)
                return Object.assign(Object.assign({}, error), { interpoliteParams: [] });
            const index = error.message.indexOf('[');
            if (index > -1) {
                return Object.assign(Object.assign({}, error), { message: error.message.slice(0, index), interpoliteParams: error.message
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.0", ngImport: i0, type: AbpUserProfileService, decorators: [{
        ...
        return [{ type: i1$1.ConfigStateService }, { type: i2.UserProfileService }, { type: i1$1.AuthService }, { type: undefined, decorators: [{
                        type: Inject,
...
class AbpLanguageService {
    ...
    subscribeLanguage() {
        ...
        this.languageService.selectedLanguage$
            .pipe(filter(Boolean))
            .subscribe(lang => {
            this.sessionState.setLanguage((lang === null || lang === void 0 ? void 0 : lang.cultureName) || '');
        });
    }
}
