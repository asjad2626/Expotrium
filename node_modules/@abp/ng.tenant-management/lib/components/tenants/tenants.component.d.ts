...
export declare class TenantsComponent implements OnInit {
    ...
    constructor(list: ListService<GetTenantsInput>, injector: Injector, confirmationService: ConfirmationService, service: TenantService, toasterService: ToasterService, fb: UntypedFormBuilder);
    ngOnInit(): void;
